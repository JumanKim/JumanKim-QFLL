...
class DifferentialEvolutionSolver(object):
    ...
    def init_population_lhs(self):
        ...
        # random samples.
        for j in tqdm(range(self.parameter_count),ascii=True,desc="Initializing"):
    ...
    def solve(self):
        ...
        # do the optimisation.
        for nit in tqdm(range(1, self.maxiter + 1),ascii=True,desc="optimizing"):
